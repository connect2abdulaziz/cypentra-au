  ...
  return (
    <div className='relative group'>
      ...
      <input
        ...
        } rounded-lg sm:rounded-xl px-3 sm:px-4 md:px-5 py-2.5 sm:py-3 md:py-4 text-sm sm:text-base text-black placeholder-black/30 transition-all outline-none font-medium`}
      />
